...
\NormalTok{lab1{-}vm          }\DecValTok{74.235}\OperatorTok{.}\DecValTok{215.246}       \DecValTok{10.0}\OperatorTok{.}\DecValTok{1.4}
\end{Highlighting}
\end{Shaded}
...
together when needed. Some extra commands need to applied manually but
in general running the scripts takes about 1 minute to launch.
